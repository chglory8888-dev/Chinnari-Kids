...
export default function Drawing() {
  ...
  function selectPicture(index) {
    setPicture(index);
    clearCanvas();
    setMessage(`🎨 Let's draw a ${pictures[index].name}!`);
  }
  ...
  function nextPicture() {
    ...
    clearCanvas();
    setMessage(
      `🎨 Let's draw a ${pictures[next].name}!`
    );
  }
  ...
  function previousPicture() {
    ...
    clearCanvas();
    setMessage(
      `🎨 Let's draw a ${pictures[previous].name}!`
    );
  }
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Fun drawing and coloring activities for kids."
        />
        ...
        <section className="learning">
          ...
          <div>
            ...
            <p>
              ...
              color and create your own drawing.
            </p>
